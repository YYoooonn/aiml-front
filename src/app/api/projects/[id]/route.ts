...
export async function GET(
  ...
  if (params.id === "search") {
    ...
    res = await fetch(`${process.env.BACKEND_API_BASE}projects/search?keyword=${k}&pageNum=${n}&pageSize=${s}`, {
      method: "GET",
      headers: header,
    })
  } else {
...
export async function PUT(
  ...
  const res = await fetch(`${process.env.BACKEND_API_BASE}projects/${params.id}`, {
    method: "PUT",
