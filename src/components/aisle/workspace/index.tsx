...
import { ChatModule } from "@/components/module";
    ...
    <div className={styles.workspaceContainer}>
      ...
      <WorkspaceBottomModule>
        ...
        <div className={styles.bottomContentContainer}>
          {selected ? (
            <Layers objts={objects} />
          ) : (
            <Chat logs={logs} sendMessage={sendMessage} />
          )}
        </div>
      </WorkspaceBottomModule>
    </div>
...
function UtilHeader({ selected, handler }: H) {
  return (
    <div className={styles.headerButtonContainer}>
      <div
        className={
          selected ? styles.headerButtonSelected : styles.headerButtonUnSelected
        }
        onClick={handler}
      >
        Layer
      ...
      <div
        className={
          selected ? styles.headerButtonUnSelected : styles.headerButtonSelected
        }
        onClick={handler}
      >
        Chat
...
function Chat({
  ...
  return (
    <div className={styles.chatWrapper}>
      <ChatModule sendMessage={sendMessage} logs={logs} />
    </div>
  );
}
